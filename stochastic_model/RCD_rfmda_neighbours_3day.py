...
RCD_rfmda_neighbours_3day.py
Changing from RCD to rfMDA (test sensitivity = 1) and including MDA of neighbours
...
phi_consts_updated = rdt_sensitivity*(tau_HH*nu_HH+tau_n*nu_n)
...
#save outputs
with open('../outputs/outI_RCD_rfmda_neighbours_3day.csv', 'ab') as f:
