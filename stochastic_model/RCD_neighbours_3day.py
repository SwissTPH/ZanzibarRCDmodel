...
RCD_neighbours_3day.py
including neighbouring houses in reactive case detection
...
nu_HH = df['nu_HH'] # number of people investigated within index HH
...
phi_consts_updated = rdt_sensitivity*(tau_HH*nu_HH+tau_n*nu_n) # now including testing of neighbours
phi_1 = np.tile(phi_consts_updated, (np.shape(followup_prop_new)[0],1))
...
#Save outputs
with open('../outputs/outI_RCD_neighbours_3day.csv', 'ab') as f:
